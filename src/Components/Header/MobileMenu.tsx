...
function MobileMenu({ isOpen, setOpen }: mobileMenu) {
  ...
  return (
    <div
      ...
      } top-0 duration-500 w-full px-4 md:w-1/2 bg-white shadow-shadow`}
    >
      <div className="p-2">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 py-4">
            <div className="flex justify-center items-center cursor-pointer rounded-xl bg-ryBackground shadow-lg h-[90px] hover:bg-ry4Text duration-700">
              <Link
                to={"/bookings"}
            ...
            <div className="flex justify-center items-center cursor-pointer rounded-xl bg-ryBackground shadow-lg h-[90px] hover:bg-ry4Text duration-700">
              <Link
                ...
                className="flex justify-center items-center flex-col gap-1"
              >
                <img src={lock2} alt="lock" className="w-5 h-5 object-cover" />
