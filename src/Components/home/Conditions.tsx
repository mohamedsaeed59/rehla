...
const Conditions = () => {
  return (
    <div className="bg-body w-[80%] mx-auto z-50 rounded-lg border border-ry4Text shadow-md p-4">
    <div className="flex flex-col gap-4">
     <h3 className="text-primary font-bold text-[22px]">Terms and Conditions</h3>
      <p className="text-[18px] font-normal text-mainBlack">Your Agreement</p>
      <div className="">
        <p className="h-[400px] overflow-y-scroll text-ry3Text text-[20px] font-normal">
          Last Revised: December 16, 2013 Welcome to www.lorem-ipsum.info. This
