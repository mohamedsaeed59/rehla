...
const ChatComponent = ({ leftLine }: Props) => {
  return (
    <div className="bg-white">
      <div className="p-3">
        <p className="text-center text-xs font-normal text-[#252525] ">
        ...
        <p className="text-[#7D7D7D] text-sm font-normal text-center py-[3px]">
          you can send your problem to our chatbot and we will fix it soon
        </p>
        <div className="flex flex-col gap-3 py-5 h-[250px] overflow-y-scroll px-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col gap-1">
              <div className="relative w-fit">
                <div className="w-fit py-3 px-4 shadow-2xl bg-white rounded-lg  flex justify-center items-center">
        ...
        <div className="my-6 flex">
          ...
          />
          <div className="bg-[#D9D9D9] rounded-tr-3xl rounded-br-3xl py-3 px-6 cursor-pointer">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
