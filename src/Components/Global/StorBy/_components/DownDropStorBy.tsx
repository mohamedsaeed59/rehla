...
export default function DownDropStorBy({setSortOption}: any) {
  ...
  return (
    <div className="absolute top-10 w-[290px] md:w-[300px] rounded-[30px] z-20 rtl:left-0 ltr:right-0 bg-white shadow-lg p-2 md:p-3">
      <ul className="w-full flex flex-col gap-2 p-2">
        <li onClick={() => handleSortChange("RateLowToHigh")}>
        ...
        <li onClick={() => handleSortChange("RateHighToLow")}>
        ...
        <li onClick={() => handleSortChange("AlphabetAZ")}>
          <div className="flex items-center gap-1 cursor-pointer">
        ...
        <li onClick={() => handleSortChange("AlphabetZA")}>
          <div className="flex items-center gap-1 cursor-pointer">
