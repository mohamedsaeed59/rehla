    ...
    <div className="w-screen h-screen">
      <div className="p-6 md:p-12">
        <div className="text-end w-full p-4">
          <button className="font-normal text-base sm:text-xl ">Skip</button>
        </div>
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="font-normal text-base text-start text-ry3Text">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-2 py-4">
              <div className="w-[50px] h-[50px] p-2 border border-borderColor rounded-[8px] flex justify-center items-center">
                <input
                  type="text"
                  placeholder="."
              ...
              <div className="w-[50px] h-[50px] p-2 border border-borderColor rounded-[8px]">
                <input
                  type="text"
                  placeholder="."
                  className="placeholder-textPlaceholder w-full h-full text-center focus:outline-none"
            ...
            <p className="text-red text-[16px]">Please enter a valid code</p>
            </div>
            ...
            <p className="text-center font-normal text-[16px] text-mainBlack">
